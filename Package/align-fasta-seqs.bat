...
rem This script runs the program align-fasta-seqs.py in a Windows environment.
rem
...
rem Execute the program align-fasta-seqs.py

%PYTHON% %PYTHON_OPTIONS% align-fasta-seqs.py %* %ARGV%
