...
rem This script runs the program get-cluster-homology-relationships.py in a Windows environment.
rem
...
%PYTHON% %PYTHON_OPTIONS% get-cluster-homology-relationships.py %* %ARGV%
