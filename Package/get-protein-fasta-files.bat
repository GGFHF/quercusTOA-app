...
rem This script runs the program get-protein-fasta-files.py in a Windows environment.
rem
...
rem Execute the program get-protein-fasta-files.py

%PYTHON% %PYTHON_OPTIONS% get-protein-fasta-files.py %* %ARGV%
